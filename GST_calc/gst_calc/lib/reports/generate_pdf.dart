...
class GeneratePdf {
  static createPdf(Customer customer, List<Item> items, double cgst, double sgst, double gtotal) async {
  ...
  for (var item in items) {
    ...
    row.cells[0].value = item.prodName;
    row.cells[1].value = item.qty.toString();
    row.cells[2].value = item.rate.toStringAsFixed(2);
    row.cells[3].value = (item.qty * item.rate).toStringAsFixed(2);
  }
  ...
  grid.draw(
    page: page,
    bounds: Rect.fromLTWH(0, 60, pageSize.width, pageSize.height - 200),
  );
  ...
  page.graphics.drawString(
    ...
    PdfStandardFont(PdfFontFamily.helvetica, 12),
    bounds: Rect.fromLTWH(20, pageSize.height - 120, 200, 20),
  );

  page.graphics.drawString(
    'SGST: ${sgst.toStringAsFixed(2)}',
    PdfStandardFont(PdfFontFamily.helvetica, 12),
    bounds: Rect.fromLTWH(20, pageSize.height - 100, 200, 20),
  );

  page.graphics.drawString(
    'Grand Total: ${gtotal.toStringAsFixed(2)}',
    PdfStandardFont(PdfFontFamily.helvetica, 14, style: PdfFontStyle.bold),
    bounds: Rect.fromLTWH(20, pageSize.height - 80, 200, 20),
  );
